...
class SimplePaulstretch {
  constructor(audioContext) {
    ...
    this.writeIndex = 0;
    this.bufferFilled = 0; // Track how much audio we've captured
  ...
  createGrain() {
    ...
    // Skip if we don't have enough audio captured yet
    const minRequired = grainSamples + this.ctx.sampleRate * 0.5;
    if (this.bufferFilled < minRequired) {
      return;
    }
